...
console.log('Using MOMO_API_BASE_URL:', MOMO_API_BASE_URL);
console.log('Using X_TARGET_ENVIRONMENT:', X_TARGET_ENVIRONMENT);
...
async function createBearerToken(subscriptionKey, xReferenceId, apiKey) {
    ...
    try {
        ...
        console.log('Bearer Token Created:', response.data.access_token);
...
async function requestPayment(xReferenceId, subscriptionKey, tokenSanitized, amount, phone, ref, providerCallbackHost) {
    console.log('Requesting Payment with:', { xReferenceId, subscriptionKey, tokenSanitized, amount, phone, ref, providerCallbackHost });
...
async function pollPaymentStatus(subscriptionKey, tokenSanitized, xReferenceId, retries = 5, delay = 50000) {
...
async function processPayment(amount, phone, reference) {
    ...
    console.log('Processing Payment with:', { amount, phone, reference, subscriptionKey, providerCallbackHost });
